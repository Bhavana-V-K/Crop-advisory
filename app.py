...
.result-desc { color: rgba(255,255,255,.75); font-size: 14px; font-weight: 300; max-width: 480px; }
...
.metric-chip .val {
    font-family: 'Playfair Display', serif;
    font-size: 26px; font-weight: 700; color: var(--moss); display: block;
}
.metric-chip .lbl {
    font-size: 11px; font-weight: 500;
    text-transform: uppercase; letter-spacing: 1.5px; color: #9AAD88;
}
...
.adv-tile:hover { transform: translateY(-3px); box-shadow: 0 8px 28px rgba(45,80,22,.12); }
.adv-tile::before {
    content: "";
...
.adv-icon { font-size: 28px; margin-bottom: 12px; display: block; line-height: 1; }
.adv-label { font-size: 11px; font-weight: 600; letter-spacing: 2px; text-transform: uppercase; color: #9AAD88; margin-bottom: 8px; }
.adv-text  { font-size: 14px; line-height: 1.65; color: var(--soil); }
...
if run:
    ...
    <div class="metrics-row">
      ...
      <div class="metric-chip">
        <span class="val">{temperature}°C</span>
